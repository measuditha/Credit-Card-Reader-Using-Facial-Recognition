...
def Cr_Amt(accnt,name):
	...
	l_title=tk.Message(creditwn,text=" AI CREDIT CARD READER BANK",relief="raised",width=2000,padx=600,pady=0,fg="yellow",bg="blue",justify="center",anchor="center")
...
def De_Amt(accnt,name):
	...
	l_title=tk.Message(debitwn,text="AI CREDIT CARD READER BANK",relief="raised",width=2000,padx=600,pady=0,fg="yellow",bg="blue",justify="center",anchor="center")
	l_title.config(font=("Broadway","40","bold"))
	l_title.pack(side="top")
...
def disp_tr_hist(accnt):
	...
	l_title=tk.Message(disp_wn,text="AI CREDIT CARD READER BANK",relief="raised",width=2000,padx=600,pady=0,fg="yellow",bg="blue",justify="center",anchor="center")
	l_title.config(font=("Broadway","40","bold"))
	l_title.pack(side="top")
...
def logged_in_menu(accnt,name):
	...
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	l_title=tk.Message(rootwn,text="AI CREDIT CARD READER BANK",relief="raised",width=2000,padx=600,pady=0,fg="yellow",bg="blue",justify="center",anchor="center")
	l_title.config(font=("Broadway","40","bold"))
	l_title.pack(side="top")
...
def log_in(master):
	...
	l_title=tk.Message(loginwn,text="AI CREDIT CARD READER BANK",relief="raised",width=2000,padx=600,pady=5,fg="yellow",bg="blue",justify="center",anchor="center")
	l_title.config(font=("Broadway","40","bold"))
	l_title.pack(side="top")
...
def Create():
	...
	l_title=tk.Message(crwn,text="AI CREDIT CARD READER BANK",relief="raised",width=2000,padx=600,pady=5,fg="yellow",bg="blue",justify="center",anchor="center")
	l_title.config(font=("Broadway","40","bold"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	x.place(y=-400)
	l_title=tk.Message(text="Welcome to AI CREDIT CARD READER BANK",relief="raised",width=2000,padx=600,pady=5,fg="yellow",bg="blue",justify="center",anchor="center")
	l_title.config(font=("Broadway","40","bold"))
	l_title.pack(side="top")
